...
public partial class @HotteInputActions : IInputActionCollection2, IDisposable
{
    ...
    public struct XRILeftHandInteractionActions
    {
        ...
        public void SetCallbacks(IXRILeftHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface != null)
            {
                ...
                @Trigger.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnTrigger;
                @Trigger.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnTrigger;
                @Trigger.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnTrigger;
                @Grip.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnGrip;
                @Grip.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnGrip;
                @Grip.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnGrip;
                @AButton.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnAButton;
                @AButton.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnAButton;
                @AButton.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnAButton;
                @BButton.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnBButton;
                @BButton.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnBButton;
                @BButton.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnBButton;
            }
    ...
    public struct XRIRightHandInteractionActions
    {
        ...
        public void SetCallbacks(IXRIRightHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface != null)
            {
                ...
                @Trigger.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnTrigger;
                @Trigger.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnTrigger;
                @Trigger.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnTrigger;
                @Grip.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnGrip;
                @Grip.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnGrip;
                @Grip.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnGrip;
                ...
                @BButton.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnBButton;
                @BButton.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnBButton;
                @BButton.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnBButton;
            }
    ...
    private IXRIGenericInteractionActions m_XRIGenericInteractionActionsCallbackInterface;
    ...
    public struct XRIGenericInteractionActions
    {
        ...
        {
            if (m_Wrapper.m_XRIGenericInteractionActionsCallbackInterface != null)
            {
                @RightStickPress.started -= m_Wrapper.m_XRIGenericInteractionActionsCallbackInterface.OnRightStickPress;
                @RightStickPress.performed -= m_Wrapper.m_XRIGenericInteractionActionsCallbackInterface.OnRightStickPress;
                @RightStickPress.canceled -= m_Wrapper.m_XRIGenericInteractionActionsCallbackInterface.OnRightStickPress;
            }
            m_Wrapper.m_XRIGenericInteractionActionsCallbackInterface = instance;
            if (instance != null)
            {
