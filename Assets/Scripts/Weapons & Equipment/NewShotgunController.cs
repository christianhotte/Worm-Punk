...
public class NewShotgunController : PlayerEquipment
{
    ...
    public Projectile Fire()
    {
        ...
        //Effects:
        audioSource.PlayOneShot(gunSettings.fireSound, PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play fire sound
        ...
        if (gunSettings.fireSound != null) audioSource.PlayOneShot(gunSettings.fireSound, PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play sound effect
    ...
    public void Eject()
    {
        ...
        //Cleanup:
        if (gunSettings.ejectSound != null) audioSource.PlayOneShot(gunSettings.ejectSound, PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play sound effect
    ...
    public void Close()
    {
        ...
        //Cleanup:
        if (gunSettings.lockSound != null) audioSource.PlayOneShot(gunSettings.lockSound, PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play sound effect
