...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (targetHitSound != null) audioSource.PlayOneShot(targetHitSound, PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play hit sound when player shoots (or damages) a target
    }
    /// <summary>
    ...
    public bool IsHit(int damage)
    {
        ...
        {
            audioSource.PlayOneShot(healthSettings.hurtSound != null ? healthSettings.hurtSound : (AudioClip)Resources.Load("Sounds/Default_Hurt_Sound"), PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play hurt sound
    ...
    {
        //Effects:
        audioSource.PlayOneShot(healthSettings.deathSound != null ? healthSettings.deathSound : (AudioClip)Resources.Load("Sounds/Temp_Death_Sound"), PlayerPrefs.GetFloat("SFXVolume", 0.5f)); //Play death sound
